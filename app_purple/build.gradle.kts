...
android {
    namespace = "ru.topbun.tasty_purple"
    compileSdk = libs.versions.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "ru.topbun.tasty_purple"
        ...
        val key = property("api_key_metric_purple")?.toString() ?: error("Not found api_key_metric in properties")
